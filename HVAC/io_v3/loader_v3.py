...
from HVAC.io_v3.serializer_v3 import project_from_dict
from HVAC.io_v3.formats.json_v3 import load_json
...
def load_project_v3(path: str) -> ProjectModelV3:
    ...
    if schema != "3.1":
        from HVAC.io_v3.migration_v3 import migrate_to_v3
