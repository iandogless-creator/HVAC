...
def build_topology_arranger_projection_v1(
    ...
    *,
    ...
    return TopologyArrangerProjectionV1(
        ...
        rows=tuple(rows),
        selected_index_room_id=leg.index_room_id,
    )
...
def _build_leg_rows(
    *,
    ...
    terminal_room_id = leg.route_room_ids[-1] if leg.route_room_ids else None
    ...
    for order, room_id in enumerate(leg.route_room_ids, start=1):
        ...
        rows.append(
            TopologyArrangerRowV1(
                ...
                order=order,
                is_index=(room_id == leg.index_room_id),
