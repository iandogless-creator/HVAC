...
HVACgooee — Project Model (v1, 2025)

This is the canonical, minimal, future-proof Project definition.
It intentionally contains *only stable v1 fields* so that:

    • Heat-Loss v1 can run
    • Hydronics v3/v4 can attach payloads later
    • Fenestration can attach window sets later
    • Serialization remains stable

A Project is the root container for:
    • project name
    • list of Spaces
    • default design temperatures
    • optional metadata

This class does NOT depend on heat-loss or hydronics controllers.
"""
