...
class ProjectState:
    ...
    # H-S70-B1 — explicit final-balancing method/Kvs-basis intent.
    hydronic_balancing_completion_basis_acceptance_intent: Optional[
        BalancingCompletionBasisAcceptanceIntentV1
    ] = None
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "hydronic_point_kvs_candidate_acceptance_intent": (
                balancing_point_kvs_candidate_acceptance_intent_to_dict_v1(
                    self.hydronic_point_kvs_candidate_acceptance_intent
                )
            ...
            "hydronic_balancing_completion_basis_acceptance_intent": (
                balancing_completion_basis_acceptance_intent_to_dict_v1(
                    self.hydronic_balancing_completion_basis_acceptance_intent
                )
                if self.hydronic_balancing_completion_basis_acceptance_intent
                else None
            ),
            ...
            "hydronic_point_accepted_valve_candidate_consequence_disposition_intent": (
                balancing_point_accepted_valve_candidate_consequence_disposition_intent_to_dict_v1(
                    self.hydronic_point_accepted_valve_candidate_consequence_disposition_intent
                )
            ...
            "hydronic_proportioned_pipe_resizing_schedule_acceptance_intent": (
                ...
                if self.hydronic_proportioned_pipe_resizing_schedule_acceptance_intent
                else None
            ),
    ...
    def from_dict(cls, data: dict) -> "ProjectState":
        ...
        raw_point_kvs_acceptance_intent = data.get(
            "hydronic_point_kvs_candidate_acceptance_intent"
        )

        if isinstance(raw_point_kvs_acceptance_intent, dict):
        ...
        if isinstance(raw_balancing_completion_acceptance_intent, dict):
            instance.hydronic_balancing_completion_basis_acceptance_intent = (
                balancing_completion_basis_acceptance_intent_from_dict_v1(
                    raw_balancing_completion_acceptance_intent
                )
            )
        ...
        raw_valve_candidate_consequence_disposition_intent = data.get(
            "hydronic_point_accepted_valve_candidate_consequence_disposition_intent"
        )
        if isinstance(
        ...
        raw_pipe_resizing_schedule_acceptance_intent = data.get(
            "hydronic_proportioned_pipe_resizing_schedule_acceptance_intent"
        )
        if isinstance(
                raw_pipe_resizing_schedule_acceptance_intent,
                dict,
        ):
            instance.hydronic_proportioned_pipe_resizing_schedule_acceptance_intent = (
                proportioned_pipe_resizing_schedule_acceptance_intent_from_dict_v1(
                    raw_pipe_resizing_schedule_acceptance_intent
                )
            )
